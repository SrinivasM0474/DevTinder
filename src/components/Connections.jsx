        ...
        <div>
            ...
            <div className="flex items-center flex-col justify-around pt-4 flex-wrap">
                {connetions.map((connection) => {
                    const { firstName, photoUrl, lastName, age, gender, about, _id } =
                        connection;
                    return (
                        <div
                            className="flex items-center bg-gray-600 mb-8 border border-b-amber-950 shadow-2xl rounded-2xl px-4"
                            key={connection._id}
                        >
                            <div className="m-4">
                                <img
                            ...
                            <Link to={'/chat/' + _id}> <button className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition duration-200 cursor-pointer mb-2.5">
                                Chat
                            </button></Link>
                        </div>
                    );
